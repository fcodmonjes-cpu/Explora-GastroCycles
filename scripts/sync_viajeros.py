...
día (2026-07-25). El roster completo (hab, nombre, edad, nac, grupo, IN/OUT)
sale del "Reporte Geos" del 25-07; las observaciones de dieta/alergia se cruzan
...
bloque se reemplaza a mano con el reporte de cada día. 47 habs · 108 viajeros
# (el reporte lista 109: Ana Cecilia Lecona sale y re-entra el 25-07 en la hab 50
# —reserva back-to-back— y se unifica en una sola tarjeta continua 22→27).
...
REPORT_DATE = "2026-07-25"   # fecha nominal del seed (día del Reporte Geos)
...
SEED_ROWS = [
    ...
    ('17', 'Walter Lopez De Almeida', 70, 'BRAZ', 'LOPEZ', '2026-07-25', '2026-07-30', ''),
    ...
    ('27', 'Luiz Fernando Furlan', 79, 'BRAZ', 'FURLAN', '2026-07-25', '2026-07-31', ''),
    ...
    ('28', 'Deborah Edidin', 77, 'USA', 'EDIDIN', '2026-07-25', '2026-07-28', 'Requerimientos alimentarios: Pescetariana'),
    ('28', 'Gary Edidin', 81, 'USA', 'EDIDIN', '2026-07-25', '2026-07-28', ''),
    ...
    ('47', 'Thais Posselt Furlan', 40, 'BRAZ', 'FURLAN', '2026-07-25', '2026-07-31', ''),
    ...
    ('50', 'Ana Cecilia Lecona Galvez', 27, 'MEXI', 'WOODBURN', '2026-07-22', '2026-07-27', ''),
]
